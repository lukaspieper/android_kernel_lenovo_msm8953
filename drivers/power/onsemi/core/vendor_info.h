...
#define SOP_P_Capable NO                    /* Not Currently Implemented */
...
#define VCONN_Swap_To_On_Supported NO		// YES
#define VCONN_Swap_To_Off_Supported NO		// YES
...
#define Src_PDO_Max_Current1 150
...
#define Type_C_Can_Act_As_Device NO
