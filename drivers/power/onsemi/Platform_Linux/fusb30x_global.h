...
#if ADDED_BY_HQ_WWM
    FSC_S32 gpio_UsbId;                             // USB_ID GPIO pin
    FSC_BOOL gpio_UsbId_value;                      // true if active, false otherwise
    FSC_S32 gpio_VconnEn;                           // VCONN_EN GPIO pin
    FSC_BOOL gpio_VconnEn_value;                    // true if enable, false otherwise
